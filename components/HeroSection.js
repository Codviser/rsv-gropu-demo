...
<h1 className="max-w-md text-4xl font-bold text-center md:text-5xl md:text-left text-blue-900">
...
/>
    ...
    <h2 className="justify-center md:justify-start text-cyan-950 m-5 text-3xl font-extrabold">
    Our Services
</h2>
...
<Link href='/' className=' p-2 px-4 pt-2 text-white bg-cyan-300 rounded-xl text-center hover:bg-cyan-900 mt-3 font-semibold'> Learn More</Link>
</div>
...
<h5 className="text-2xl md:text-3xl font-medium mt-3">geotechnical survey</h5>
<p className="text-slate-500 text-lg mt-3">
